...
namespace oeis
{
    ...
    inline const Sequences seq_fixed =
    {
        ...
        { "A151832", // n = 6: https://oeis.org/A151832
          { 1, 1, 6, 66, 901, 13881, 231008, 4057660, 74174927, 1398295989,
            27012396022, 532327974882, 10665521789203, 216696065279573,
            4455636282185802, 92567760074841818 } },
    };
    ...
    inline const Sequences seq_free =
    {
        ...
        { "free6", // n = 6: ???
          { /* GJL */ 1, 1, 1, 2, 7, 26, 153, 1134, 11027, 127989,
            /*`GJL */ 1725296, 25965365, 425925737 } },
    };
    ...
    inline const Sequences seq_symm =
    {
        ...
        empty,
        { "symm6", // n = 6:
          { /* GJL */ 1, 1, 1, 2, 7, 26, 153, 1132, 10892, 122521, 1551390,
            /* GJL */ 21189722, 305441521 } }
    };
    ...
    inline const Sequences seq_asymm =
    {
        ...
        empty,
        { "asymm6", // n = 6:
          { /* GJL */ 0, 0, 0, 0, 0, 0, 0, 2, 135, 5468, 173906, 4775643,
            /* GJL */ 120484216 } }
    };

    inline const Sequences seq_strict =
    {
        empty,
        empty,
        empty,
        { "A006766", // n = 3: https://oeis.org/A006766
          { 0, 0, 0, 0, 2, 11, 77, 499, 3442, 24128, 173428, 1262464, 9307494,
          } },
        { "A006767", // n = 4: https://oeis.org/A006767
          { 0, 0, 0, 0, 0, 3, 35, 412, 4888, 57122, 667959, 7799183,
            /* GJL */ 91280759, 1072254298, 12656640831, } },
        { "A006768", // n = 5: https://oeis.org/A006768
          { 0, 0, 0, 0, 0, 0, 6, 104, 2009, 36585, 647680, 11173880,
            /* GJL */ 189808204, 3193767213, } },
        { "strict6",
          { /* GJL */ 0, 0, 0, 0, 0, 0, 0, 11, 319, 8869, 231574, 5712765,
            /* GJL */ 135465680, } }
    };
    ...
    inline const Sequences& cubes (const char *name)
    {
        ...
        if (! strcmp (name, "strict")) return seq_strict;
